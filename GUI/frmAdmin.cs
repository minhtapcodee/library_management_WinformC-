...
namespace QUANLYTHUVIENC3.GUI
{
    public partial class frmAdmin : Form
    {
        ...
        frmCaiDat frmCaiDat;
        frmTongHop frmTongHop;
        private Control mdiClient;
        private Button lastActiveButtonInMenuContainer;
        private bool isLightTheme = false; // Track current theme
    ...
    ApplyTheme(); // Apply default theme
        ...
        public void Reload()
        {
            try
            {
                ...
                // Example: Reload labels, charts, grids, etc.
                LoadThongTinTongQuan(); // Example method to load overview data
                // Add other methods if you have more data to reload
                // LoadBieuDo(); // Example: Reload charts
                // LoadDataGridView(); // Example: Reload grid data
            }
            catch (Exception ex)
            {
        ...
        {
            // Example: Logic to load overview data
            // lblSomeValue.Text = someBLL.GetData().ToString();
            // This should contain the actual logic you use to load data in frmTongHop
        }
        private void ApplyTheme()
        {
            Color sidebarColor = isLightTheme ? Color.FromArgb(180, 255, 200) : Color.FromArgb(23, 24, 29); // #B4FFC8
            Color buttonBackColor = isLightTheme ? Color.FromArgb(180, 255, 200) : Color.FromArgb(23, 24, 29); // #B4FFC8
            Color buttonForeColor = isLightTheme ? Color.Black : Color.White;
            Color panelTopColor = isLightTheme ? Color.FromArgb(102, 255, 51) : Color.DarkSlateGray; // #66FF33
        ...
        {
            Color defaultBackColor = isLightTheme ? Color.FromArgb(180, 255, 200) : Color.FromArgb(23, 24, 29); // #B4FFC8
        ...
        {
            Color activeBackColor = isLightTheme ? Color.FromArgb(51, 102, 204) : SystemColors.ButtonShadow; // #3366CC
            ...
            selectedButton.FlatAppearance.BorderColor = isLightTheme ? Color.FromArgb(51, 153, 255) : Color.DarkGray; // Giữ viền xanh dương
        ...
        private void frmTongHop_FormClosed(object sender, FormClosedEventArgs e)
        {
            frmTongHop = null;
        }
        ...
        private void btnDashboard_Click_1(object sender, EventArgs e)
        {
            ...
            if (frmTongHop == null)
            {
                frmTongHop = new frmTongHop();
                frmTongHop.FormClosed += frmTongHop_FormClosed;
                frmTongHop.MdiParent = this;
                frmTongHop.Dock = DockStyle.Fill;
                frmTongHop.Show();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (frmNgayCong == null)
            {
                frmNgayCong = new frmNgayCong();
                frmNgayCong.FormClosed += frmNgayCong_FormClosed;
                frmNgayCong.MdiParent = this;
                frmNgayCong.Dock = DockStyle.Fill;
                frmNgayCong.Show();
            }
            else
            {
                frmNgayCong.Activate();
            }
        }

        private void frmNgayCong_FormClosed(object sender, FormClosedEventArgs e)
        {
            frmNgayCong = null;
        }
